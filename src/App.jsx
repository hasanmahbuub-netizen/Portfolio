      ...
      <main className="front-page">
        <article className="lead-story">
          ...
          <div className="multi-column-2">
            ...
            <h3 className="tertiary-headline" style={{marginTop: '1.5rem'}}>SKILLS & ARSENAL</h3>
            <p>
              <strong>Commercial:</strong> B2B Distribution, Brand Management, Trade Marketing, Performance Marketing (Meta/Google Ads), ROAS Tracking.<br/>
              <strong>Tools & Tech:</strong> Make.com, N8N, Meta Ads Manager, Google Analytics.<br/>
              <strong>Education:</strong> BBA in Marketing, North South University (Expected May 2026).
            </p>
        ...
        <aside className="sidebar">
          ...
          <section className="secondary-story">
            ...
            <div className="venture-box">
              <img src="/bishod.png" alt="Bishod App" className="venture-img" />
            ...
            <div className="venture-box">
              <img src="/meek.png" alt="Meek App" className="venture-img" />
